-- Rollback 025: 활동 요약 이메일을 다시 단일 수신자(YOUR_ADMIN_EMAIL@example.com)로 복원
-- Migration 024의 send_activity_digest() 정의로 되돌린다.
-- (전체 함수 본문은 20260307_024_activity_digest_cron.sql 참조)
